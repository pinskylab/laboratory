...
1.1 If the DNA samples contain EDTA, perform a 3X bead-based cleanup with KAPA Pure Beads to remove EDTA prior to fragmentation. Please refer to the KAPA Pure Beads Technical Data Sheet for a detailed DNA cleanup protocol.
...
Dilute the amount of dsDNA to be used for library construction as follows:
