...
Examine the extraction table, find candidates for future digests, create a plan and send proposed locations to the database.
```{r setup}
# load libraries
library(tidyverse)
...
For each plate in the database, generate plate maps of source extract plates and destination digest plates using the code found at the bottom of the prep[ ].R code.
